...
async function loadFacts() {
  const res = await fetch(
    "https://ztzbktqwbtrdflnxkspi.supabase.co/rest/v1/facts",
    {
      headers: {
        apiKey:
        ...
        authorization:
          "Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Inp0emJrdHF3YnRyZGZsbnhrc3BpIiwicm9sZSI6ImFub24iLCJpYXQiOjE3MjUxMDc1MjUsImV4cCI6MjA0MDY4MzUyNX0.aHkpXIxYJ-c_HjVYVNLZ80xIS6nbfuaahVJCJn-b2kY",
      },
    }
  );
...
function createFactsList(dataArray) {
  // factsList.insertAdjacentHTML("afterbegin", "<li>ROMEO</li>");
...
console.log([7, 6, 8, 9, 64, 95, -10].filter((el) => el > 10));
console.log([7, 6, 8, 9, 64, 95, -10].find((el) => el > 10));

/*
let votesInteresting = 23;
let votesMindlowing = 5;
const text = "Lisbon is a the captital of purtagal";
...
//alert(message);
const text = "Lisbon is the captital of protugal";
...
/*
//----ARRAYS------//
const fact = ["Listbosn is the capital of portugal", 2015, true];
...
const factObj = {
  text: "Listbosn is the capital of portugal",
  category: "society",
  createdIn: 2015,
  isCorrect: true,
